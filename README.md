About qt-networkauth-feedstock
==============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/qt-networkauth-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/qt-networkauth-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add qt6-networkauth
# for installing globally
pixi global install qt6-networkauth
```
...
It is possible to list all of the versions of `qt6-networkauth` available on your platform:
...
```
pixi search qt6-networkauth --channel conda-forge
```
